...
export const SEED_VERSES: Verse[] = [
  {
    ...
    approvedText: 'Tiedättehän itsekin, veljet, että tulomme luoksenne ei ollut turha.',
  ...
  },
  {
    ...
    approvedText: 'Olimme, kuten tiedätte, ennen joutuneet Filippissä kärsimään ja kestämään pahaa kohtelua, mutta Jumalamme antoi meille rohkeuden julistaa teille hänen evankeliumiaan kovienkin vastuksien keskellä.',
  ...
  },
  {
    ...
    approvedText: 'Kehotuksemme ei näet johdu harhasta eikä epäpuhtaista vaikuttimista, emmekä yritä pettää ketään.',
  ...
  },
  {
    ...
    approvedText: 'Jumala on hyväksynyt meidät ja uskonut meille evankeliumin, ja siksi me puhumme, emme ihmisten mielen mukaisesti vaan Jumalan, joka tutkii sydämemme.',
  ...
  },
  {
    ...
    approvedText: 'Emme ole koskaan puhuneet mielistellen, kuten tiedätte, emmekä peittäneet ahneuttamme — Jumala on todistajamme.',
  ...
  },
  {
    ...
    approvedText: 'Emme ole tavoitelleet kenenkään ylistystä, emme teidän emmekä muiden, vaikka olisimme Kristuksen apostoleina voineet vaatia arvonantoa.',
  ...
  },
  {
    ...
    approvedText: 'Mutta me olimme teidän keskuudessanne lempeät, niin kuin imettävä äiti hellästi hoivaa lapsiaan.',
  ...
  },
  {
    ...
    approvedText: 'Niin hellät tunteet meitä valtasivat, että halusimme antaa teille Jumalan evankeliumin lisäksi oman henkemme, koska olitte tulleet meille niin rakkaiksi.',
  ...
  },
  {
    ...
    approvedText: 'Muistattahan, veljet, meidän vaivannäkömme ja rasituksemme. Yötä päivää työtä tehden julistimme teille Jumalan evankeliumia, jotta emme olisi olleet kenellekään teistä rasituksena.',
  ...
  },
  {
    ...
    approvedText: 'Te olette todistajina, samoin Jumala, kuinka pyhästi, oikeamielisesti ja moitteettomasti me uskovia kohtaan vaelsimme.',
  ...
  },
  {
    ...
    approvedText: 'Tiedättehän, että olemme jokaista teistä kuin isä lapsiaan kehottaneet ja rohkaisseet',
  ...
  },
  {
    ...
    approvedText: 'ja vaatineet vaeltamaan Jumalan arvoisesti, hänen, joka kutsuu teidät valtakuntaansa ja kirkkauteensa.',
  ...
  },
  {
    ...
    approvedText: 'Sen vuoksi me myös lakkaamatta kiitämme Jumalaa siitä, että kun saitte meiltä Jumalan sanan, te ette ottaneet sitä vastaan ihmisten sanana vaan Jumalan sanana, jota se todellakin on ja joka myös vaikuttaa teissä, jotka uskotte.',
  ...
  },
  {
    ...
    approvedText: 'Te olette näet, veljet, seuranneet Jumalan Kristuksessa Jeesuksessa olevia seurakuntia Juudeassa, sillä te olette saaneet kärsiä omalta kansaltanne samaa kuin hekin juutalaisilta,',
  ...
  },
  {
    ...
    approvedText: 'jotka tappoivat sekä Herran Jeesuksen että profeetat ja ovat vainonneet meitäkin eivätkä ole Jumalalle mieliksi ja ovat kaikkia ihmisiä vastaan.',
  ...
  },
  {
    ...
    approvedText: 'He yrittävät estää meitä puhumasta pakanakansoille, että nämä pelastuisivat, ja niin he tekevät syntiensä mitan aina vain täyteen. Mutta viha on heidät vihdoin saavuttanut.',
  ...
  },
  {
    ...
    approvedText: 'Me, veljet, jouduttuamme hetkeksi eroon teistä — tosin vain kasvoilta, emme sydämeltä — yritimme sitäkin suuremmalla kaipauksella innokkaasti päästä tapaamaan teitä.',
  ...
  },
  {
    ...
    approvedText: 'Halusimme tulla luoksenne — minä Paavali kerran ja toisen kerran — mutta Saatana esti meidät.',
  ...
  },
  {
    ...
    approvedText: 'Sillä kuka on meidän toivomme, ilomme ja kerskauksemme seppele Herramme Jeesuksen edessä hänen tullessaan? Ettekö juuri te?',
  ...
  },
  {
    ...
    approvedText: 'Te olette meidän kunniamme ja ilomme.',
...
export const SEED_PROPOSALS: Proposal[] = [
  // tw-3: partial votes (Arto approved, others pending)
  {
    ...
    selectedVoters: ['liukko-arto', 'kaikkonen-sointu', 'mantsinen-matti', 'valimaki-maria', 'ahvenainen-martti', 'kivinen-riku', 'leino-kimmo'],
  ...
  // tw-5: rejected (single rejection resolves immediately)
  {
    ...
    votes: [
      { userId: 'kaikkonen-sointu', decision: 'approve', createdAt: '2026-04-25T09:00:00Z' },
      { userId: 'mantsinen-matti', decision: 'reject', comment: 'Jakeiden 4–6 käännösratkaisut vaativat vielä tarkistamista. Erityisesti jae 5 on epäselvä.', createdAt: '2026-04-26T11:00:00Z' },
    ],
